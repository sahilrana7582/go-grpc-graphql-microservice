...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x04role\x18\x03 \x01(\tR\x04role2\x86\x01\n" +
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponse\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseBMZKgithub.com/sahilrana27582/go-grpc-graphql-microservice/user-service/grpc/pbb\x06proto3"
